...
/**
 * Vista que representa la sala de espera dentro del juego. Permite a los
 * jugadores ver quiénes están en la sala, su estado de preparación (listo o
 * no), así como interactuar mediante botones para continuar o salir.
 *
 * Esta vista se comunica con un modelo de vista (presentador) que contiene la
 * lógica relacionada con esta pantalla.
 *
 * @author ivanochoa
 * @author paulvazquez
...
public class VistaSalaEspera implements IVistaPanel, IVistaSalaEspera {
    ...
    /**
     * Panel principal del juego donde se mostrarán los componentes de esta
     * vista.
     */
    ...
    /**
     * Imagen del título utilizado en la vista de sala.
     */
    ...
    /**
     * Tabla que muestra la lista de jugadores en la sala y su estado (listo o
     * no listo).
     */
    ...
    /**
     * Vista modelo asociado a la vista de la sala de espera, que maneja la
     * lógica de negocio.
     */
     ...
     *
     * @param vistaPanel Panel principal del juego donde se mostrarán los
     * componentes de esta vista.
    ...
    /**
     * Dibuja la vista de la sala de espera, mostrando el código de acceso y la
     * lista de jugadores.
     *
    ...
    /**
     * Crea los componentes de la interfaz gráfica de la vista de sala de
     * espera.
     */
    @Override
    ...
    /**
     * Elimina los componentes de la vista de la sala de espera del panel
     * principal.
     */
    @Override
    ...
    /**
     * Deshabilita el botón de continuar para que el jugador no pueda
     * presionarlo.
     */
    @Override
     ...
     *
     * @return {@code true} si el jugador está listo, de lo contrario
     * {@code false}.
     */
    @Override
     ...
     *
     * @param listo {@code true} si el jugador está listo, de lo contrario
     * {@code false}.
     */
    @Override
    ...
    /**
     * Carga las imágenes necesarias para la visualización de la sala de espera,
     * incluyendo la portada y el título.
     */
